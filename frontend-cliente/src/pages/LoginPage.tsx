        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mt-8">
            ...
            <div className="mt-4 flex justify-center">
              {[
                { label: 'Huésped Demo', email: 'huesped@hotelflux.com', pass: 'Huesped123!', color: 'bg-emerald-50 text-emerald-700 ring-emerald-200 hover:bg-emerald-100', icon: <IconCrown size={16} /> },
              ].map((u) => (
