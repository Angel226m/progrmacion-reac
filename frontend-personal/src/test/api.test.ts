...
describe('API Client', () => {
  ...
  describe('Admin API endpoints patterns', () => {
    it('endpoints admin siguen patrón correcto', () => {
      const adminEndpoints = [
        '/api/v1/admin/pisos',
        '/api/v1/admin/personal',
        '/api/v1/admin/turnos',
        '/api/v1/admin/horarios/semana',
        '/api/v1/admin/dashboard',
        '/api/v1/admin/analitica/reservas',
        '/api/v1/admin/analitica/ingresos',
        '/api/v1/admin/analitica/productos',
        '/api/v1/admin/exportar/reservas',
        '/api/v1/admin/exportar/ingresos',
        '/api/v1/admin/exportar/personal',
      ];

      adminEndpoints.forEach((ep) => {
        expect(ep).toMatch(/^\/api\/v1\/admin\//);
      });
      expect(adminEndpoints).toHaveLength(11);
    });
