...
export const MOCK_HABITACIONES: readonly Habitacion[] = [
  ...
  { id: 'hab-302', numero: '302', tipo: 'penthouse', piso: 3, capacidad: 4, precio_noche: '450.00', estado: 'ocupada', amenidades: ['WiFi', 'TV', 'Minibar', 'Jacuzzi', 'Terraza', 'Butler'], clasificacion: 'premium', caracteristicas: { jacuzzi: true, terraza: true, butler: true }, notas: 'VIP Guest', inserted_at: now, updated_at: now },
