...
import { TareaObservableRepository } from './tarea.repository';
import type { IHabitacionRepository, IReservaRepository, ITareaRepository } from '../../application/ports';

export interface Repositories {
  readonly habitaciones: IHabitacionRepository;
  readonly reservas: IReservaRepository;
  readonly tareas: ITareaRepository;
}
...
export function createRepositories(token: string): Repositories {
  ...
  const repos: Repositories = {
    ...
    tareas: new TareaObservableRepository(token),
  };
...
export { TareaObservableRepository } from './tarea.repository';
